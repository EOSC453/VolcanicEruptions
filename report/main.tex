...
equilibrium has zonal temperatures identical to the steady-state described in
Figure \ref{fig:steadystate}. In the lower equilibrium case, the temperature 
difference between high-latitudinal and mid-latitudinal zones is much smaller.
