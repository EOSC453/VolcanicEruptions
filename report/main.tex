...
\usepackage{caption}
\usepackage{csvsimple,booktabs} % load csvs into table
\usepackage{filecontents}   % read csv data contents

\newcommand*\mean[1]{\overline{#1}}

% style our references section
\usepackage[backend=biber,style=authoryear]{biblatex}

% load resources from bib file
\addbibresource{references.bib}

% set indent length for each paragraphy
\setlength{\parindent}{1.5em} 
% set first paragraph of each section to be indented
